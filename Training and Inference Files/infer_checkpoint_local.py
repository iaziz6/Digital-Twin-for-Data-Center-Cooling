...
MODEL_FILE = "/mnt/c/Users/iaziz6/Downloads/Training/UNet.0.16.mdlus"
NUM_THREADS = 15
...
def main():
    ...
    metrics_df.to_csv("internal_115_metrics.csv", index=False)
    ...
    out_df.to_csv("internal_115_true_vs_pred.csv", index=False)

    np.savez(
        "internal_115_true_vs_pred.npz",
        x=pts[:, 0],
        y=pts[:, 1],
        z=pts[:, 2],
        Ux_true=U_true[:, 0],
    ...
    print("\nSaved:")
    print("  internal_115_metrics.csv")
    print("  internal_115_true_vs_pred.csv")
    print("  internal_115_true_vs_pred.npz")
    print("\nMetrics:")
