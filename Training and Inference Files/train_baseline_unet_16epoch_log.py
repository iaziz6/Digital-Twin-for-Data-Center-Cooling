...
def main(cfg: DictConfig) -> None:
    ...
    # Training data folder. Can be overridden from command line with:
    # +data_path=/home/iaziz6/Imo_Training/Training
    data_path = cfg.get("data_path", "/home/iaziz6/Imo_Training/Training")
    val_data_path = cfg.get("val_data_path", data_path)
    checkpoint_dir = cfg.get(
        "checkpoint_dir",
        "/home/iaziz6/Imo_Training/Training/checkpoints_baseline_unet",
    )
    ...
    logger.info(
        f"Using baseline UNet training with train_num_samples={cfg.train_num_samples}, "
        f"val_num_samples={cfg.val_num_samples}, max_epochs={cfg.max_epochs}, "
        f"log_every_steps={log_every}, val_every_steps={val_every}, "
        f"save_every={save_every}, checkpoint_dir={checkpoint_dir}."
    )
